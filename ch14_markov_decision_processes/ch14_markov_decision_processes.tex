...
\begin{figure}
\includegraphics[width=0.7\textwidth]{tikz1-figure0.pdf}
\caption{Problem setting}
\label{0}
\end{figure}
\begin{figure}
\includegraphics[width=0.7\textwidth]{tikz1-figure1.pdf}
...
\begin{figure}
\includegraphics[width=0.7\textwidth]{tikz1-figure6.pdf}
\includegraphics[width=0.7\textwidth]{tikz1-figure7.pdf}
